# training tf model for 256x256 pixel constant-q spectrograms
...
PROJECTDIR = "D:/work/2022/TechnoGAN/networks/Spect_256x256_cq2/"
...
def make_generator_model():
    ...
    model.add(layers.Dense(64 * 64 * 128, use_bias=False, input_shape=(noise_dim,)))
...
# number of constant-q bins and base frequency to convert from
# should be same as what was used to create training data
CQ_BINS = 24
CQ_BASE = 8.175
